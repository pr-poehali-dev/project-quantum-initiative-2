    ...
    >
      <nav className="container mx-auto px-6 flex items-center justify-between md:px-[24]">
        <a href="/" className="flex items-center gap-2 group" onClick={scrollToTop}>
          <span className="text-white font-semibold text-lg tracking-tight">НефтеТранс</span>
        </a>
        ...
        <a
          href="#contact"
          className="hidden md:inline-flex items-center gap-2 text-sm px-5 py-2.5 transition-all duration-300 bg-orange-500 text-white hover:bg-orange-600"
        >
          Получить расчёт
        </a>
      ...
      >
        <div className="container mx-auto px-6">
          <ul className="flex flex-col gap-6 mb-8">
            {[
              ...
              <li key={item.label}>
                <a
                  href={item.href}
                  className="hover:text-orange-400 transition-colors duration-300 text-white text-4xl font-light block"
          ...
          <a
            href="#contact"
            className="inline-flex items-center justify-center gap-2 text-sm px-5 py-2.5 bg-orange-500 text-white hover:bg-orange-600 transition-all duration-300 mb-4"
            onClick={closeMobileMenu}
          >
            Получить расчёт
          </a>
